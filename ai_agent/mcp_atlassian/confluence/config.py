...
class ConfluenceConfig:
    ...
    auth_type: Literal["basic", "pat", "oauth", "token"]  # Authentication type
    username: str | None = None  # Email or username
    api_token: str | None = None  # API token used as password
    personal_token: str | None = None  # Personal access token (Server/DC)
    custom_token: str | None = None  # Custom API token for custom endpoints
    ...
    def from_env(cls) -> "ConfluenceConfig":
        ...
        custom_token = os.getenv("CONFLUENCE_CUSTOM_TOKEN")
        ...
        if oauth_config:
            ...
            # Custom token authentication for custom API endpoints
            auth_type = "token"
        elif is_cloud:
