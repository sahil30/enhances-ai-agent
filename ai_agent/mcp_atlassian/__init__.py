...
@click.option(
    "--confluence-custom-token",
    help="Custom API token for Confluence custom endpoints",
)
@click.option(
...
@click.option(
    "--jira-custom-token",
    help="Custom API token for Jira custom endpoints",
)
@click.option(
...
def main(
    ...
    confluence_custom_token: str | None,
    ...
    if click_ctx and was_option_provided(click_ctx, "confluence_custom_token"):
        os.environ["CONFLUENCE_CUSTOM_TOKEN"] = confluence_custom_token
    ...
    if click_ctx and was_option_provided(click_ctx, "jira_custom_token"):
        os.environ["JIRA_CUSTOM_TOKEN"] = jira_custom_token
